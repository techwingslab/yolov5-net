...
namespace Yolov5Net.Scorer.Models
{
    ...
    {
        public override int Width { get; } = 1280;
        public override int Height { get; } = 1280;
        public override int Depth { get; } = 3;

        public override int Dimensions { get; } = 85;

        public override float[] Strides { get; } = new float[] { 8, 16, 32, 64 };
        ...
        public override int[] Shapes { get; } = new int[] { 20, 40, 80, 160 };
        ...
        public override string Weights { get; } = "assets/weights/yolov5s6.onnx";
